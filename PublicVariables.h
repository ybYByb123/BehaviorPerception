...
struct PubSysStruct
{
	...
	char WtsPath[256]; // yolov5 enigine路径
	float fConfThresh;
	float fNmsThresh;
	int iClassNum; // 权重检测目标类别
	...
	char ClothOnnxPath[256]; //工作服classifier的onnx路径
	char HelmetOnnxPath[256]; //安全帽classifier的onnx路径
};
